// 지금 많이 읽고 있는 작품
    ...
    try {
        ...
        // .box 요소 전체 선택
        const boxElements = document.querySelectorAll(".section .swiper-slide");
        ...
        boxElements.forEach((box, i) => {
            ...
            h3.textContent = doc.title.substring(0,5);
            box.appendChild(h3);
...
async function bookData3() {
    ...
    try {
        ...
        // .box 요소 전체 선택
        const boxElements = document.querySelectorAll(".section3 .swiper-slide");
        console.log(boxElements)
